...
import com.shinelon.bio.BioServer;
...
public class AIOServer implements Runnable {
    ...
    public static void main(String[] args) throws IOException {
        new Thread(new AIOServer(BioServer.port, 1)).start();
    }
    ...
    private void init() {
        try {
            asynchronousChannelGroup = AsynchronousChannelGroup.withCachedThreadPool(Executors.newCachedThreadPool(),
                    threadSize);
